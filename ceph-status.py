...
def Health():
    import subprocess 
    p = subprocess.Popen([ceph, 'health', '-f', 'json-pretty'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    try:
...
def Monitors():
    import subprocess 
    p = subprocess.Popen([ceph, 'status', '-f', 'json-pretty'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    try:
        out, err = p.communicate()
...
def GetOsd():
    import subprocess 
    p = subprocess.Popen([ceph, 'osd', 'dump', '-f', 'json-pretty'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    try:
        out, err = p.communicate()
...
def SpaceRados():
    import subprocess 
    p = subprocess.Popen([rados, 'df', '-f', 'json-pretty'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    try:
        out, err = p.communicate()
...
def Info():
    ...
    import subprocess 
    p = subprocess.Popen([ceph, 'pg', 'stat', '-f', 'json-pretty'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    try:
        out, err = p.communicate()
